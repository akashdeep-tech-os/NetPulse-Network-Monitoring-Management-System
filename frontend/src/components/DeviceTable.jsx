...
const statusBadge = (status) => STATUS_BADGE[status] || STATUS_BADGE.Unknown;
              ...
              devices.map((device, idx) => (
                ...
                >
                  ...
                  <td className="px-4 py-2 text-center">
                    <span
                      className={`inline-block px-2.5 py-0.5 rounded-full text-[11px] font-semibold ${statusBadge(device.status)}`}
                    >
                      {device.status}
                    </span>
                  </td>
          ...
          devices.map((device) => (
            ...
            >
              <div className="flex items-start justify-between gap-2">
                ...
                <span
                  className={`shrink-0 px-2 py-0.5 rounded-full text-[10px] font-semibold ${statusBadge(device.status)}`}
                >
                  {device.status}
                </span>
              </div>
